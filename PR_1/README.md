...
Выводы по подкурсу Basic Building Blocks: 1. Способ присвоения значения
переменной в R заключается в использовании оператора присваивания,
который представляет собой просто символ “меньше, чем”, за которым
следует знак “минус”. Это выглядит следующим образом: \<- 2. Чтобы
просмотреть содержимое переменной, необходимо ввести ее и нажать Enter
...
z на 2. Затем он добавил по 100 к каждому элементу. 7. Чтобы извлечь
